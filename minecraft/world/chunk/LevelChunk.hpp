...
namespace mc
{
    ...
    public:
        ...
        {
            MLINK_FUNC(void, 0x025A1AD0)();
        }

        static void ReleaseThreadStorage()
        {
            MLINK_FUNC(void, 0x025A1B8C)();
        }

        ArrayWithLength<uint8_t> getBiomes()
        {
            return MLINK_FUNC(ArrayWithLength<uint8_t>, 0x025A0CC0, LevelChunk *)(this);
        }
        ...
        void setBiomes(ArrayWithLength<uint8_t> biomes)
        {
            MLINK_FUNC(void, 0x025A1188, LevelChunk *, ArrayWithLength<uint8_t>)(this, biomes);
        }

        void updateBiomePresentFlags()
        {
            MLINK_FUNC(void, 0x025A0CE4, LevelChunk *)(this);
        }
    ...
    MC_CHECK_SIZE(LevelChunk, 0x248);
} // namespace mc
