...
namespace mc
{
    ...
    public:
        ...
        {
            return MLink::DereferencePointerFromOffset<MinecraftServer>(0x104CB6FC);
        }

        ServerConnection *getConnection()
        {
            return MLINK_FUNC(ServerConnection *, 0x03226010, MinecraftServer *)(this);
        }

        ServerLevel *getLevel(int index)
        {
            return MLINK_FUNC(ServerLevel *, 0x03222954, MinecraftServer *, int)(this, index);
        }

        PlayerList *getPlayers()
        {
            return MLINK_FUNC(PlayerList *, 0x03225F74, MinecraftServer *)(this);
        }
