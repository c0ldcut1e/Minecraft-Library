...
namespace mc
{
    class NQRNetworkManager_WiiU : public NQRNetworkManager
    {
    public:
        enum class ENEXAsyncProcess : uint32_t
        {
            None                        = 0,
            Login                       = 1,
            Unknown2                    = 2,
            ...
            Logout                      = 4,
            FindSessionById             = 5,
            UpdateExternalRoomData      = 6,
            CreateSession               = 7,
            JoinSession                 = 8,
            LeaveSession                = 9,
            BrowseSessions              = 10,
            UpdateMatchmakingAttributes = 11,
            JoinRandomSession           = 12,
        };

        enum class ENEXConnectionState : uint32_t
        {
            Connecting   = 0,
            Unknown1     = 1,
            Ready        = 2,
        ...
        {
            return MLink::DereferencePointerFromOffset<NQRNetworkManager_WiiU>(0x104CFBDC);
        }

        NQRNetworkManager_WiiU(INQRNetworkManagerListener *listener)
        {
            MLINK_FUNC(void, 0x0348ACC4, NQRNetworkManager_WiiU *, INQRNetworkManagerListener *)(this, listener);
        }

        void AddConnectedPlayer(mc::NQRNetworkPlayer *player)
        {
        ...
        void FindOrCreateNonNetworkPlayer(int playerIndex, int playerType, NQRNetworkManager::PlayerSyncData *syncData)
        {
            MLINK_FUNC(void, 0x0348E228, NQRNetworkManager_WiiU *, int, int, NQRNetworkManager::PlayerSyncData *)(this, playerIndex, playerType,
                                                                                                                  syncData);
        }

        int *GetBrowsedSessionInfoList()
        {
            return MLINK_FUNC(int *, 0x0351F038, NQRNetworkManager_WiiU *)(this);
        }

        NQRNetworkPlayer *GetLocalPlayerByUserIndex(int userIndex)
        {
            return MLINK_FUNC(NQRNetworkPlayer *, 0x0349D554, NQRNetworkManager_WiiU *, int)(this, userIndex);
        }

        NQRNetworkPlayer *GetPlayerByIndex(int index)
        {
            return MLINK_FUNC(NQRNetworkPlayer *, 0x0349CBB8, NQRNetworkManager_WiiU *, int)(this, index);
        }

        NQRNetworkPlayer *GetPlayerFromStationIdAndLocalIdx(uint64_t stationId, int smallId)
        {
        ...
        {
            MLINK_FUNC(void, 0x0349B20C, NQRNetworkManager_WiiU *, uint32_t, int, const void *)(this, _sessionId, playerMask, presenceSyncInfo);
        }

        void MapRoomSlotPlayers(int roomSlotPlayerCount = -1)
        {
            MLINK_FUNC(void, 0x0348E5DC, NQRNetworkManager_WiiU *, int)(this, roomSlotPlayerCount);
        }

        void NetworkPlayerConnectionComplete(mc::NQRNetworkPlayer *player)
        {
            MLINK_FUNC(void, 0x03496218, NQRNetworkManager_WiiU *, mc::NQRNetworkPlayer *)(this, player);
        }

        void NetworkPlayerSmallIdAllocated(mc::NQRNetworkPlayer *player, uint8_t smallId)
        {
            MLINK_FUNC(void, 0x0348E4FC, NQRNetworkManager_WiiU *, mc::NQRNetworkPlayer *, uint8_t)(this, player, smallId);
        }

        void NonNetworkPlayerComplete(mc::NQRNetworkPlayer *player, uint8_t smallId)
        {
            MLINK_FUNC(void, 0x0348C594, NQRNetworkManager_WiiU *, mc::NQRNetworkPlayer *, uint8_t)(this, player, smallId);
        }

        void Pia_BrowseSession()
        {
            MLINK_FUNC(void, 0x03492B78, NQRNetworkManager_WiiU *)(this);
        }

        void Pia_JoinSession()
        {
            MLINK_FUNC(void, 0x03492760, NQRNetworkManager_WiiU *)(this);
        }

        void Pia_SignalJoinSession()
        {
            MLINK_FUNC(void, 0x034931CC, NQRNetworkManager_WiiU *)(this);
        }

        bool Pia_StartupSession()
        {
            return MLINK_FUNC(bool, 0x03493090, NQRNetworkManager_WiiU *)(this);
        }
        ...
        void SyncRoomData()
        {
            MLINK_FUNC(void, 0x0348F23C, NQRNetworkManager_WiiU *)(this);
        }
        ...
        uint32_t field_0xC8;
        uint32_t field_0xCC;
        eNQRNetworkManagerInternalState internalState;
        uint32_t field_0xD4;
        uint8_t field_0xD8;
        bool isHosting;
        uint8_t field_0xDA;
        ...
        mstd::vector<NQRNetworkPlayer *> vecTempPlayers;
        ...
        NQRNetworkPlayer *aRoomSlotPlayers[8];
    ...
    MC_CHECK_SIZE(NQRNetworkManager_WiiU, 0x13C0);
} // namespace mc
